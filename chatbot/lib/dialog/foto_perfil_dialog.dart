...
class FotoPerfilDialog extends StatefulWidget {
  ...
  FotoPerfilDialog({required this.cliente}) : super();
...
class FotoPerfilDialogState extends State<FotoPerfilDialog> {
  ...
  FotoPerfilDialogState({required this.cliente});
                    ...
                    children: <Widget>[
                      Container(
                        child: ElevatedButton.icon(
                            ...
                            label: Text('Galería'),
                            onPressed: !prefs.isExplorar ? _subirFoto : null),
                      ),
                      Container(
                        child: ElevatedButton.icon(
                            style: ElevatedButton.styleFrom(
                            ...
                            icon: Icon(FontAwesomeIcons.camera,
                                color: prs.colorIcons, size: 20.0),
                            label: Text('Cámara'),
                            onPressed: !prefs.isExplorar ? _tomarFoto : null),
                      ),
                    ],
                  ),
          ],
  ...
  _cambiarFoto() async {
    ...
    ClienteModel _cliente = prefs.clienteModel;
