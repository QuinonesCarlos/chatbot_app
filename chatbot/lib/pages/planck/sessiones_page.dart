...
class _SessionesPageState extends State<SessionesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Donde iniciaste sesión')),
  ...
  _cerrarTotas() {
    _enviarCancelar() async {
      ...
      _saving = true;
      setState(() {});
      await _sessionProvider.cerrar((estado, error) {}, all: true);
      _saving = false;
      setState(() {});
    }
  ...
  Widget _listaCar(context) {
    return Container(
      child: FutureBuilder(
        future: _sessionProvider.listar(),
        ...
        IconSlideAction(
          ...
          onTap: () async {
            _enviarCerrarSession() async {
              ...
              _saving = true;
              setState(() {});
              await _sessionProvider.cerrar((estado, error) {
