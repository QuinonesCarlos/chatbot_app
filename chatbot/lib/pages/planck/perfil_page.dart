...
class _PerfilPageState extends State<PerfilPage> {
  ...
  late TextEditingController _inputFieldDateController;
            ...
            actions: <Widget>[
              ...
              ElevatedButton.icon(
                  ...
                  onPressed: () {
                    ...
                    _sessionProvider.cerrar((estado, error) {
                      if (estado == 1) {
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          _estrellas(),
          Text(
              "Campañas: ${_cliente.registros} / Mensajes: ${_cliente.correctos}",
